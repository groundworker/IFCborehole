...
file_out = open("Modell_Aufschuesse_KombiniertMitAnsatzpunkt.ifc", "w")
...
for j, row in enumerate(data['ID_STAMMDATEN']):
    ...
    if data['ID_STAMMDATEN'][j] not in data_stammid:
        ...
        file_out.write("#"+str(i)+"07= IFCBUILDINGELEMENTPROXY('"+str(randomString(22))+"',4,'"+str(data['ID_STAMMDATEN'][j])+"',$,$,#"+str(i)+"81,#"+str(i)+"84,$,$);\n")
        ...
        for i_point in circlepoints():
            i_pointid += 1
            file_out.write("#"+str(i)+str(i_pointid)+"= IFCCARTESIANPOINT(("+str(float(RW)+radius*i_point[0])+","+str(float(HW)+radius*i_point[1])+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
            if i_pointid == 11:
        ...
        file_out.write("#"+str(i)+"89= IFCCARTESIANPOINT(("+str(RW+1.5*radius)+","+str(HW+0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"90= IFCCARTESIANPOINT(("+str(RW-1.5*radius)+","+str(HW+0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"91= IFCCARTESIANPOINT(("+str(RW-1.5*radius)+","+str(HW-0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"92= IFCCARTESIANPOINT(("+str(RW+1.5*radius)+","+str(HW-0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")                       
        ...
        file_out.write("#"+str(i)+"96= IFCCARTESIANPOINT(("+str(RW+0.1*radius)+","+str(HW+1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"97= IFCCARTESIANPOINT(("+str(RW+0.1*radius)+","+str(HW-1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"98= IFCCARTESIANPOINT(("+str(RW-0.1*radius)+","+str(HW-1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")
        file_out.write("#"+str(i)+"99= IFCCARTESIANPOINT(("+str(RW-0.1*radius)+","+str(HW+1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j]+0.01)+"));\n")                        
