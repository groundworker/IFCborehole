...
#file_out.write("#401= IFCCIRCLEPROFILEDEF(.AREA.,$,#402,#"+str(radius)+");\n")
#file_out.write("#402= IFCAXIS2PLACEMENT3D(#403,#904,#902);\n")
#file_out.write("#403= IFCCARTESIANPOINT((.0,.0,.0));\n")

file_out.write("#500= IFCBUILDING('"+str(randomString(22))+"',$,'Baugrundaufschluesse',$,$,#511,$,$,.ELEMENT.,$,$,$);\n")
file_out.write("#511= IFCLOCALPLACEMENT($,#512);\n")
file_out.write("#512= IFCAXIS2PLACEMENT3D(#901,$,$);\n")
...
file_out.write("#521= IFCRELAGGREGATES('"+str(randomString(22))+"',#110,$,$,#500,(#520));\n")
file_out.write("#521= IFCAXIS2PLACEMENT3D(#901,$,$);\n")
file_out.write("#522= IFCLOCALPLACEMENT($,#521);\n")
file_out.write("#530= IFCBUILDINGSTOREY('"+str(randomString(22))+"',#110,'Ebene Punkte',$,'Ebene:Ebene',#118,$,'point-Storey',.ELEMENT.,.0);\n")
file_out.write("#521= IFCRELAGGREGATES('"+str(randomString(22))+"',#110,$,$,#500,(#530));\n")
...
for j, row in enumerate(data['ID_STAMMDATEN']):
    ...
    if data['ID_STAMMDATEN'][j] not in data_stammid:
        ...
        file_out.write("#"+str(i)+"69= IFCRELDEFINESBYPROPERTIES('"+str(randomString(22))+"',$,$,$,(#"+str(i)+"80),#"+str(i)+"60);\n")

        file_out.write("#"+str(i)+"70= IFCSHAPEREPRESENTATION(#202,'Body','SurfaceModel',(#"+str(i)+"71));\n") 
        file_out.write("#"+str(i)+"71= IFCSHELLBASEDSURFACEMODEL((#"+str(i)+"72,#"+str(i)+"76,#"+str(i)+"77));\n") 
        file_out.write("#"+str(i)+"72= IFCCLOSEDSHELL((#"+str(i)+"73));\n")
        file_out.write("#"+str(i)+"73= IFCFACE((#"+str(i)+"74));\n")
        file_out.write("#"+str(i)+"74= IFCFACEOUTERBOUND(#"+str(i)+"75,.T.);\n")
        file_out.write("#"+str(i)+"75= IFCPOLYLOOP(("+str(data_point)+",#"+str(i)+"11));\n")
        file_out.write("#"+str(i)+"76= IFCCLOSEDSHELL((#"+str(i)+"86));\n") 
        file_out.write("#"+str(i)+"77= IFCCLOSEDSHELL((#"+str(i)+"93));\n")
        file_out.write("#"+str(i)+"78= IFCSTYLEDITEM(#"+str(i)+"71,(#801),$);\n")
        file_out.write("#"+str(i)+"80= IFCBUILDINGELEMENTPROXY('"+str(randomString(22))+"',4,'"+str(data['ID_SCHICHTDATEN'][j])+"','borehole point',$,#"+str(i)+"81,#"+str(i)+"84,$,$);\n")
        file_out.write("#"+str(i)+"81= IFCLOCALPLACEMENT(#511,#"+str(i)+"82);\n")
        file_out.write("#"+str(i)+"82= IFCAXIS2PLACEMENT3D(#"+str(i)+"83,$,$);\n")
        file_out.write("#"+str(i)+"83= IFCCARTESIANPOINT((.0,.0,.0));\n")
        file_out.write("#"+str(i)+"84= IFCPRODUCTDEFINITIONSHAPE($,$,(#"+str(i)+"70));\n")
        file_out.write("#"+str(i)+"85= IFCRELCONTAINEDINSPATIALSTRUCTURE('"+str(randomString(22))+"',110,$,$,(#"+str(i)+"80),#530);\n")

        file_out.write("#"+str(i)+"86= IFCFACE((#"+str(i)+"87));\n") 
        file_out.write("#"+str(i)+"87= IFCFACEOUTERBOUND(#"+str(i)+"88,.T.);\n")
        file_out.write("#"+str(i)+"88= IFCPOLYLOOP((#"+str(i)+"89,#"+str(i)+"90,#"+str(i)+"91,#"+str(i)+"92,#"+str(i)+"89));\n")
        file_out.write("#"+str(i)+"89= IFCCARTESIANPOINT(("+str(RW+1.5*radius)+","+str(HW+0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"90= IFCCARTESIANPOINT(("+str(RW-1.5*radius)+","+str(HW+0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"91= IFCCARTESIANPOINT(("+str(RW-1.5*radius)+","+str(HW-0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"92= IFCCARTESIANPOINT(("+str(RW+1.5*radius)+","+str(HW-0.1*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")                       
        file_out.write("#"+str(i)+"93= IFCFACE((#"+str(i)+"94));\n") 
        file_out.write("#"+str(i)+"94= IFCFACEOUTERBOUND(#"+str(i)+"95,.T.);\n") 
        file_out.write("#"+str(i)+"95= IFCPOLYLOOP((#"+str(i)+"96,#"+str(i)+"97,#"+str(i)+"98,#"+str(i)+"99,#"+str(i)+"96));\n")
        file_out.write("#"+str(i)+"96= IFCCARTESIANPOINT(("+str(RW+0.1*radius)+","+str(HW+1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"97= IFCCARTESIANPOINT(("+str(RW+0.1*radius)+","+str(HW-1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"98= IFCCARTESIANPOINT(("+str(RW-0.1*radius)+","+str(HW-1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")
        file_out.write("#"+str(i)+"99= IFCCARTESIANPOINT(("+str(RW-0.1*radius)+","+str(HW+1.5*radius)+","+str(data['ANSATZHOEHE_NN'][j])+"));\n")                        
